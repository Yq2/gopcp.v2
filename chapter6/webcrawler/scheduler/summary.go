...
func (ss *mySchedSummary) Struct() SummaryStruct {
	...
	return SummaryStruct{
		...
		Downloaders:     getModuleSummaries(registrar, module.TypeDownloader),
		Analyzers:       getModuleSummaries(registrar, module.TypeAnalyzer),
		Pipelines:       getModuleSummaries(registrar, module.TypePipeline),
